...
var fetchOneGraph = function (config) { return __awaiter(void 0, void 0, void 0, function () {
    var accessToken, appId, operationName, query, variables, payload, body, url, result, value, networkError_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                url = "https://serve.onegraph.com/graphql?app_id=" + appId + "&show_metrics=false";
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, basicPost(url, {
            ...
            case 3:
                ...
                internalConsole_1.internalConsole.warn("Network error fetching Netlify Graph upstream: " + JSON.stringify(networkError_1, null, 2));
                return [2 /*return*/, {}];
            case 4: return [2 /*return*/];
        }
    });
