    ...
    <div className="homeContainer">
        <section className="headerbanner">
          <div className="Headertext">
            <p className="heading" style={{ textAlign: "center", color: "#ffffff", paddingTop: 50, paddingBottom: 30, fontSize: 40}}>
        ...
        <div className="hero">                                  
            <div className="herotext">
              ...
              <div className="text">                                  
                <p>
                  <img style={{ marginRight: 15, verticalAlign: "bottom" }} src="data:image/png;base64," alt="" />
                  Chris Wagstaff is an Army Veteran with an Operational Tour under his belt. He is a qualified teacher, fitness coach and self taught artist. 
                  He has self published a 70,000 word fantasy novel and draws for 7-10 hours daily. His goal is to become a full time NFT artist, comic creator and author.
                </p>                                  
                <p>
                  <img style={{ marginRight: 15, verticalAlign: "bottom" }} src="data:image/png;base64," alt="" />
                  Every single Dogface Soldier and army trait has been hand-drawn with immaculate attention to detail. 
                  All of the art is drawn in Chris's home studio using a wacom tablet. 
                  No Dogface Soldier or trait has been outsourced or produced with the help of AI or computers.
                </p>    
                <p>
                  <img style={{ marginRight: 15, verticalAlign: "bottom" }} src="data:image/png;base64," alt="" />
                  The launch of the Dogface Discord has seen the community grow and come together as a powerful force. 
                  The community has already contributed to traits, the minting platform, marketing strategies, the story and many other aspects of the project.
                </p>   
                <p>
                  <img style={{ marginRight: 15, verticalAlign: "bottom" }} src="data:image/png;base64," alt="" />
                  Dogface Army founder Mark Tulloch has created a YouTube Playlist that documents the development of the Dogface NFT project from Day 1. 
                  The daily brief is a tell all where you will see the intense dedication to the community and project from the fully doxxed HQ team.
                </p>       
              </div>
              <button className="btn" style={{ marginBottom: 40 }}> Join The Discord </button>
            </div>
        ...
        <div>
            <img src="collection.png" alt="" style={{ width: "100%", height: "auto" }} />
        </div>

        <div className="watchloves">
          <img src="rarity.png" alt="" style={{ maxWidth: 450}} />
          <a href="#/mint" className="connecthyper" style={{ margin: "50px auto 60px auto", display: "table"}}>MINT NOW</a>
          <h2>DOGFACE ARMY OUR PLEDGE</h2>
          <p>
            Both Mark Tulloch and Chris Wagstaff are retired Army Veterans. 
            We also have a number of other Vets involved in the project as well as a team of dedicated civilians.
          </p>
          <p>For this reason, it is our pledge to donate 10% of all minting revenue & trading residuals to VETERAN CAUSES.</p>
          <p>In unison with this pledge, we will work with the DAO to make decisions around where the pledge goes.
              Our promise is to provide complete transparency on all charity funds & donations.
          </p>
        </div>
        ...
        <div className="hero mintsteps">                                             
            <div className="herotext">
              ...
              <div className="text">                                  
                <p>
                  NFTs #301 - #2444 (Whitelist + Public)
                </p>                                  
                <p>
                  0.08 ETH
                </p>    
